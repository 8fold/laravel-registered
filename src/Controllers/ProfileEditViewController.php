...
class ProfileEditViewController extends BaseController
{
    ...
    private function namesSection($user)
    {
        return Html::section([
            ...
            ])->attr('method post', 'action ./edit/update-names')
        ]);
    }
    ...
    private function siteAddressSection($user)
    {
        ...
        if ($user->canAddSiteAddresses) {
            ...
            $siteSelect = $this->siteTypeSelect('new_site_address_select');
            ...
            foreach ($user->profile->sites as $site) {
                $forms[] = Html::form([
                        ...
                        Html::div([
                            ...
                            UIKit::link([
                                'delete',
                                './edit/sites/'. $site->public_key .'/delete'
                        ...
                        'method post',
                        'action ./edit/sites/'. $site->public_key);
            }
        ...
        if ($user->canCreateBiography) {
            $return = Html::section([
                    ...
                    Html::form([
                        ...
                        ])->hideLabel()->attr('id biography-editor', 'name biography')
                    ])->attr('method post', 'action ./edit/biography'),
